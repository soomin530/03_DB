...
-- 3. "국어국문학과"에 다니는 여학생 중 현재 휴학 중인 여학생을 찾아달라는 요청이 들어왔다.
...
-- 굳이 JOIN 하지 않고 DEPARTMENT_NO = '001';로 해서 답 구할 수 있음


-- 4. 도서관에서 대출 도서 장기 연체자 둘을 찾아 이름을 게시하고자 한다.
...
-- WHERE CAPACITY BETWEEN 20 AND 30; 으로 작성해도 답 나옴



-- 6. 춘 기술대학교는 총장을 제외하고 모든 교수들이 소속 학과를 가지고 있다.
--    그럼 춘 기술대학교 총장의 이름을 알아낼 수 있는 SQL 문장을 작성하시오
--    교수 중에 소속학과가 없는 사람 = 총장
...
--    선수과목이 존재하는 과목들을 어떤 과목인지 과목번호를 조회해보시오.
...
FROM TB_STUDENT
WHERE STUDENT_ADDRESS LIKE '전주%' AND SUBSTR(ENTRANCE_DATE, 1, 2) = '02'
AND ABSENCE_YN = 'N' -- 휴학한 사람들 제외
