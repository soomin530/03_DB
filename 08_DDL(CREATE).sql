 ...
 * * USER_CONSTRAINTS : 계정이 작성한 제약 조건을 확인할 수 있는 딕셔너리 뷰
...
--   테이블 생성 시 해당 컬럼에 지정된 DEFAULT 값으로 삽입이 됨!! *
...
-- 가입일 -> INSERT 시 미작성 하는 경우 DEFAULT 값이 반영되는 지 확인
-- INSERT INTO 테이블명 (컬럼명1, 컬럼명2...)
-- VALUES(값1, 값2...)
INSERT INTO "MEMBER" (MEMBER_ID, MEMBER_PWD, MEMBER_NAME)
VALUES ('MEM03', 'POIUY4567', '이지연');


-- ** JDBC에서 날짜를 입력받았을 때 삽입하는 방법
-- '2024-10-15 12:20:30' 이런 식의 문자열이 넘어온 경우...
INSERT INTO "MEMBER"
VALUES ('MEM04', 'PASS04', '김길동', '920321-1234567', 
...
SELECT * FROM MEMBER2; -- MEMBER_TEL : 1,012,341,234
...
-- ORA-01400: NULL을 ("KH_WSM"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다

--> USER_NO에 걸어놓은 NOT NULL 제약조건을 위배하여 오류 발생
...
--    컬럼 레벨에서 설정 가능, 테이블 레벨에서도 설정 가능 (중복값 허용 X)
...
-- 2) 테이블 레벨 : [CONSTRAINT 제약조건명] 제약조건(컬럼명)<- 어떤 컬럼에 제약을 거는 지 알아야 해서.
...
INSERT INTO USER_USED_UK
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_WSM.USER_ID_U)에 위배됩니다
--> 제약조건명 USER_ID_U인 제약조건에 위배된다.
--> USER_ID_U 에 UNIQUE(중복값X) 제약조건 걸려있음
...
-- * 복합키 지정은 테이블 레벨만 가능하다! (컬럼 레벨에서는 X) *
...
INSERT INTO USER_USED_UK2
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_WSM.USER_ID_NAME_U)에 위배됩니다
--> CONSTRAINT USER_ID_NAME_U UNIQUE(USER_ID, USER_NAME)
...
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_WSM.USER_NO_PK)에 위배됩니다
-- 기본키 중복 오류!

INSERT INTO USER_USED_PK
VALUES (NULL, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1111', 'yoo123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_WSM"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
-- 기본키 NULL 이므로 오류!
...
INSERT INTO USER_USED_PK2
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_WSM.PK_USERNO_USERID)에 위배됩니다
-- USER_NO, USER_ID 둘 다 중복되었을 때만 제약조건 위배 에러 발생!

INSERT INTO USER_USED_PK2
VALUES (NULL, 'USER03', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_WSM"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2
VALUES (3, NULL, 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_WSM"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다
-- 둘 중 하나라도 NULL이면 위배하여 에러 발생
...
-- USER_GRADE (부모테이블/참조테이블)에 10 이라는 GRADE_CODE가 존재하므로 INSERT 가능
...
-- USER_GRADE (부모테이블/참조테이블)에 30 이라는 GRADE_CODE가 존재하므로 INSERT 가능
...
-- ORA-02291: 무결성 제약조건(KH_WSM.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
--> 외래키 제약 조건에 위배되어 오류 발생
--> 무슨 오류? 10, 20, 30만 넣어놨고 50은 안 넣었음
...
-- ORA-02292: 무결성 제약조건(KH_WSM.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다

-- GRADE_CODE 중 20은 외래키로 참조되고 있지 않으므로 삭제가 가능함
DELETE FROM USER_GRADE WHERE GRADE_CODE = 20;
-- 자식 레코드로서 사용되고 있지 않기 때문에 삭제 가능!

SELECT * FROM USER_GRADE; -- 20 삭제됨 확인
...
-- 1) ON DELETE SET NULL : 부모키 삭제 시 자식 키를 NULL로 변경하는 옵션
...
SELECT * FROM USER_GRADE2; -- 10 삭제됨 확인
SELECT * FROM USER_USED_FK2; -- 홍길동, 이순신이 쓰던 자식레코드 값 10 삭제되면서 NULL로 변경됨 확인
...
SELECT * FROM USER_USED_FK3; --> 부모의 10 참조하고 있던 자식 행(1, 2행) 삭제됨
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_WSM.GENDER_CHECK)이 위배되었습니다
...
INSERT INTO USER_USED_CHECK
VALUES (2, 'USER02', 'PASS02', '유관순', '여', '010-3333-1111', 'yoo123@kh.or.kr');
-- 가능

INSERT INTO USER_USED_CHECK
VALUES (2, 'USER02', 'PASS02', '유관순', '여자', '010-3333-1111', 'yoo123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_WSM.GENDER_CHECK)이 위배되었습니다

--> GENDER 컬럼에 CHECK 제약 조건으로 '남' 또는 '여'만 삽입 가능하도록 설정해둠
